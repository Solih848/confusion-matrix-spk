...
echo '<tr><th></th><th colspan="2">Aktual</th></tr>';
echo '<tr><th>Prediksi</th><th>Layak</th><th>Tidak Layak</th></tr>';
$layak = isset($confusionMatrix['Layak']) ? $confusionMatrix['Layak'] : ['tp' => 0, 'fn' => 0, 'fp' => 0, 'tn' => 0];
echo '<tr>';
echo '<th>Layak</th>';
